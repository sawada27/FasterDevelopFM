...
namespace FasterDevelopFM.Tools.VertificationCodeGenerator
{
    public static class QrCodeGenerator
    {
        ...
        public static byte[] GetQrCode(string text)
        {
            ...
            {
                throw new ArgumentNullException("parameter text can not be null");
            }
        ...
        public static void SaveAsPng(QrCode qrCode, string filename, int scale, int border, SKColor foreground, SKColor background)
        {
